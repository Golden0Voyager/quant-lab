...
alias stock-cache='sqlite3 /Users/hainingyu/Code/quant_data/quant_cache.db "SELECT symbol, datetime(cached_at, \"unixepoch\", \"localtime\") as cached_time FROM data_cache ORDER BY cached_at DESC LIMIT 20;"'
alias stock-cache-clear='rm -f /Users/hainingyu/Code/quant_data/quant_cache.db && echo "缓存已清除"'
